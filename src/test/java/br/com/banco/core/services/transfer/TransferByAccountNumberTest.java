...
class TransferByAccountNumberTest {
    @InjectMocks
    private TransferByAccountNumber transferByAccountNumber;
    @Mock
    ...
    void getTransfersByAccount() {
        ...
        List<TransferResponse> result = transferByAccountNumber.getTransfersByAccount(
                12,
                null,
                null,
                null);
